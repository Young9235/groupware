package com.softleaf.groupware.common;
...
public class Constants
{
	...
	public static final String BOARD_DOWN_LOAD_PATH		= "/Users/softleaf/saveFolder/";
	
	public static final String CONTEXT_ATTATCH_PATH		= "/attach";
	
	//board sub folder
	public static final String BOARD_SUB_FOLDER			= "Board";	// 한 페이지에서 보여지는 레코드 수
	//board sub folder
